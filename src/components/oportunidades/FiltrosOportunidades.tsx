 ...
 *
 * Vacantes y proyectos filtran por lo mismo —ubicación, área y orden—, así que mantener
...
export function FiltrosOportunidades({
  ciudades, areas, ordenes, ciudad, area, orden, desc,
  onCiudad, onArea, onOrden, onDesc, prefijo,
}: Props) {
  return (
